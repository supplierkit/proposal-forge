    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-500 mt-1">Track and manage your group sales pipeline.</p>
        </div>
        <div className="flex gap-2">
          <div className="flex rounded-md border border-gray-300 overflow-hidden">
            <button
              className={`px-3 py-1.5 text-sm ${view === "board" ? "bg-blue-50 text-blue-700" : "bg-white text-gray-600"}`}
              onClick={() => setView("board")}
            >
              Board
            </button>
            <button
              className={`px-3 py-1.5 text-sm ${view === "list" ? "bg-blue-50 text-blue-700" : "bg-white text-gray-600"}`}
